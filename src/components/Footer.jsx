const Footer = () => {
  return (
    ...
    <footer className="bg-slate-950 text-white px-6 pt-24 pb-12 border-t border-slate-900">
  ...
  <div className="w-8 h-8 bg-indigo-600 rounded-lg flex items-center justify-center text-white font-bold">D</div>
            ...
            <span className="font-bold text-xl tracking-tight">DigiTools</span>
          </div>

     <p className="text-slate-400 text-sm leading-relaxed max-w-xs">
            Empowering creators and businesses with professional digital tools since 2024. Building the future of digital workflows.
          </p>
     ...
     <a href="#" className="w-10 h-10 bg-slate-900 rounded-full flex items-center justify-center text-slate-400 hover:text-white hover:bg-indigo-600 transition-all">
        ...
        <div>
          ...
          <ul className="space-y-4 text-sm text-slate-400">
            ...
            <li><a href="#" className="hover:text-indigo-400 transition-colors">Tools</a></li>
      ...
      <div className="max-w-7xl mx-auto pt-8 border-t border-slate-900 flex flex-col md:flex-row justify-between items-center gap-6 text-xs text-slate-500">
